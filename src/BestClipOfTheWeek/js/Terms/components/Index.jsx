    ...
    if (colorPickerShown) {
      colorPickerElt = (
        <div className="popover">
          ...
          <SketchPicker className="relative" color={colorPickerColor} onChangeComplete={this.handleColorPickerChangeComplete} disableAlpha />
        </div>
      );
    }
    ...
    const termEltsList = terms.map(term => (
      <div key={term.termId} className="form-row term-form-row ease" data-id={term.termId}>
        <div className="form-group d-flex">
          <input className="form-control" maxLength="50" onChange={this.handleTermNameChange} placeholder={term.name} type="text" value={term.name} />
        </div>
        <div className="form-group d-flex">
          <div role="button" className="swatch" onClick={this.handleColorSwatchClick} onKeyDown={this.handleKeyDown} tabIndex="0">
    ...
    return (
      <div className="container-fluid">
        ...
        <div className="form-row term-form-row ease" data-id={newTerm.termId}>
          <div className="form-group d-flex">
            <input className="form-control" maxLength="50" onChange={this.handleNewTermNameChange} placeholder="Add a term" type="text" value={newTerm.name} />
          </div>
          <div className="form-group d-flex">
            <div role="button" className="swatch" onClick={this.handleColorSwatchClick} onKeyDown={this.handleKeyDown} tabIndex="0">
