...
export function Privacy() {
  return (
    <>
      <div>
        <h1>Privacy</h1>
        <p>Effective date: @(DateTime.Now.ToString("MMMM dd, yyyy"))</p>

        <p>
          Best Clip of the Week ("us", "we", or "our") operates the https://www.bestclipoftheweek.com/ website (the
          "Service").
        </p>
        <p>
          This page informs you of our policies regarding the collection, use, and disclosure of personal data when you
          use our Service and the choices you have associated with that data. Our Privacy Policy for Best Clip of the
          Week is managed through{' '}
        ...
        <p>
          ...
          https://www.bestclipoftheweek.com/
        </p>
        ...
        <h2>Use of Data</h2>
        <p>Best Clip of the Week uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          Best Clip of the Week will take all steps reasonably necessary to ensure that your data is treated securely
        ...
        <p>
          Best Clip of the Week may disclose your Personal Data in the good faith belief that such action is necessary
          to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of Best Clip of the Week</li>
        ...
        <ul>
          <li>By email: justinprobb@gmail.com</li>
        </ul>
      </div>
    </>
  )
