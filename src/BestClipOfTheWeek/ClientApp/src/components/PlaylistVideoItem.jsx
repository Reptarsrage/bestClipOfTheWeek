...
export default class PlaylistVideoItem extends Component {
  ...
  render() {
    ...
    const img =
      (thumb && thumb.url && (
        <img alt="" className="img-fluid rounded d-none d-md-block w-20 mr-3 ease" src={thumb.url} />
      )) ||
      null
      ...
      >
        <div className="media">
          ...
          <div className="media-body text-truncate">
            ...
            <small className="text-nowrap text-truncate text-default mt-0">
              {DateTime.fromFormat(subtitle, 'F').toFormat('ff')}
            </small>
          </div>
        </div>
      </div>
